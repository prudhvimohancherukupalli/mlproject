...
from src.exception import CustomException                 # fixed module name
from src.logger import logging
from src.utils import save_object, evaluate_models        # ensure this exists
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array, preprocessor_path=None):
        """
        Expect train_array and test_array as numpy arrays where the last column is the target.
        Optionally accept preprocessor_path (not used here).
        """
        try:
            ...
            if best_model_score < 0.60:
                raise CustomException("No sufficiently good model found (R² < 0.60)", sys)
